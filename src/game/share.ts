...
//
// T17 (Legend screen): exported, along with the 5 terminal/prefix glyphs
// below, so the in-game Legend page can render the §2.9 emoji table FROM this
// map rather than retyping the glyphs — single source of truth, per the T17
// brief ("import it"). Nothing about shareString's own logic changes.
